...
namespace MWBase
{
    ...
    public:
        ...
        virtual std::pair<MWWorld::Ptr, osg::Vec3f> getHitContact(const MWWorld::ConstPtr& ptr, float distance,
            ...
            std::optional<osg::Quat> originOrientation = std::nullopt)
            = 0;
        ...
        virtual void launchMagicBolt(
            ...
            = 0;
        virtual void launchMagicBolt(const ESM::RefId& spellId, const MWWorld::Ptr& caster, const osg::Vec3f& worldPos,
            osg::Quat orient, int slot)
            = 0;
